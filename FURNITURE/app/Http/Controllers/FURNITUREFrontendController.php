...
class FURNITUREFrontendController extends Controller
{
    public function index()
    {
        ...
        return view('FURNITURE.index', compact('orders'));
    }
    ...
    public function show($orderId)
    {
        ...
        return view('FURNITURE.show', compact('order', 'orderDetails'));
    }
    ...
    public function ordersTable()
{
    ...
    return view('FURNITURE.orders-table', compact('orders'));
}
...
public function updateOrderStatus(Request $request)
{
 ...
 $lmdResponse = Http::withHeaders([
            'Authorization' => 'Bearer furniture-api-key' // ✅ Send API key in header
