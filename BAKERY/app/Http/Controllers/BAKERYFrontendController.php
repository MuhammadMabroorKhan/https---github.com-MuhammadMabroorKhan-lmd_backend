...
class BAKERYFrontendController extends Controller
{
    public function index()
    {
        ...
        return view('BAKERY.index', compact('orders'));
    }
    ...
    public function show($orderId)
    {
        ...
        return view('BAKERY.show', compact('order', 'orderDetails'));
    }
    ...
    public function ordersTable()
{
    ...
    return view('BAKERY.orders-table', compact('orders'));
}
...
public function updateOrderStatus(Request $request)
{
 ...
 $lmdResponse = Http::withHeaders([
            'Authorization' => 'Bearer BAKERY-api-key' // ✅ Send API key in header
