...
return new class extends Migration
{
    ...
    Schema::create('pharmacy_images', function (Blueprint $table) {
        $table->id();
        $table->unsignedBigInteger('pharmacy_id'); // Foreign key to restaurants table
        ...
        Schema::create('stocks', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('itemdetails_ID'); // Links to Item Details table
    ...
    Schema::create('orders', function (Blueprint $table) {
        ...
        $table->enum('paymentstatus', ['confirmed_by_customer','confirmed_by_vendor', 'pending', 'confirmed_by_deliveryboy'])->default('pending');
