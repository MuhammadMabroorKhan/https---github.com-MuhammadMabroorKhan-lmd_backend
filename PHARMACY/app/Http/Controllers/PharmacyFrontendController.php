...
class PharmacyFrontendController extends Controller
{
    ...
    public function show($orderId)
    {
        ...
        return view('pharmacy.show', compact('order', 'orderDetails'));
    }
    ...
    public function ordersTable()
{
    ...
    return view('pharmacy.orders-table', compact('orders'));
}
...
public function updateOrderStatus(Request $request)
{
    ...
    if ($statusType === 'payment') {
        if ($incomingStatus === 'confirmed_by_vendor' && $order->paymentstatus !== 'confirmed_by_deliveryboy') {
 ...
 $lmdResponse = Http::withHeaders([
            'Authorization' => 'Bearer pharmacy-api-key' // ✅ Send API key in header
